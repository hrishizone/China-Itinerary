...
export const days = [
  {
    ...
    blocks: [
      ...
      { time: '13:20', icon: 'food', wiki: ["Peking duck"], title: 'Lunch: Peking duck at Siji Minfu (Qianmen branch)', detail: 'The locals’ answer to Quanjude, at half the price. A whole duck is ¥208 and feeds two comfortably — crisp lacquered skin dipped in caster sugar first, then meat rolled in pancakes with scallion and sweet bean sauce. Get a queue ticket the moment you arrive; the wait is 40 min at peak and worth every minute.', cost: 1250, tag: 'Must-eat' },
      ...
      { time: '16:00', icon: 'landmark', wiki: ["Tiananmen Square"], title: 'Tiananmen Square', detail: 'Free, but you MUST reserve a passport-linked slot on the official WeChat mini-program 1–7 days ahead — walk-ups are turned away. Security is airport-grade. The square is 440,000 m²: Monument to the People’s Heroes in the middle, Mao’s Mausoleum south, the Great Hall of the People west.', cost: 0, tag: 'Book ahead' },
      { time: '17:00', icon: 'walk', wiki: ["Dashilan", "Hutong"], title: 'Dashilan & Yangmeizhu Xiejie hutong walk', detail: 'Skip the sanitised main drag. Duck west into Yangmeizhu Xiejie — a 500-year-old slanted lane now full of independent bookshops (try Modernista), tiny galleries and grandmothers playing xiangqi. This is the Beijing that the Forbidden City queue never sees.', cost: 0, tag: 'Free' },
      { time: '18:15', icon: 'camera', wiki: ["Zhengyangmen"], title: 'Zhengyangmen Gate at blue hour', detail: 'The 40 m Ming gate tower at the square’s south end lights up around sunset. Stand on the Qianmen pedestrian street looking north — gate, tram tracks and lanterns all in one frame. The photograph of the trip, taken on Day 1.', cost: 0, tag: 'Photo' },
      { time: '19:30', icon: 'food', wiki: ["Zhajiangmian"], title: 'Dinner: zhajiangmian in the alley', detail: 'Old Beijing fried-sauce noodles at Fangzhuanchang Zhajiangmian — ¥22, hand-pulled, buried under eight little dishes of julienned vegetables you tip in and thrash together. Add a bowl of douzhi (fermented mung-bean drink) if you are brave; it tastes like a dare.', cost: 380, tag: 'Cheap eat' },
      { time: '21:00', icon: 'moon', wiki: ["Wangfujing"], title: 'Wangfujing night stroll, then sleep', detail: 'A 15-minute metro hop for the neon, the Xinhua bookstore and a last street snack. In bed by 22:30 — tomorrow is the biggest walking day of the week.', cost: 120, tag: 'Optional' },
    ],
    tips: [
...

  {
    ...
    blocks: [
      ...
      { time: '12:15', icon: 'zap', wiki: ["Alpine slide", "Mutianyu"], title: 'Toboggan back down', detail: 'A 1,580 m stainless-steel luge from Tower 6 to the base, ¥120. You control the brake. It is unapologetically silly and you will grin the entire way. Do not get stuck behind a nervous rider — leave a gap at the top.', cost: 0, tag: 'Fun' },
      { time: '13:00', icon: 'food', wiki: ["Rainbow trout", "Chinese cuisine"], title: 'Lunch in Mutianyu village', detail: 'The farmhouse restaurants at the base do a proper nongjia meal — trout from the mountain stream, stir-fried wild greens, hand-rolled noodles, ¥60–80 a head. Xiaolongfeng or The Schoolhouse (pricier, run by an American, excellent).', cost: 780, tag: 'Local' },
      ...
      { time: '17:00', icon: 'palette', wiki: ["798 Art Zone"], title: '798 Art Zone', detail: 'A decommissioned 1950s East-German-built electronics factory turned into China’s biggest contemporary art district — Bauhaus sawtooth roofs, Mao-era slogans still stencilled on the girders, and 400 galleries underneath them. Free to wander; UCCA charges ¥60 if a show grabs you. Best coffee in Beijing is here too.', cost: 0, tag: 'Free' },
      { time: '19:00', icon: 'food', wiki: ["Beijing railway station"], title: 'Dinner near Beijing Railway Station', detail: 'Collect the big bag, then eat before you board — the train dining car is grim. Grab a proper meal plus supplies for the sleeper: instant noodles (every carriage has a boiling-water tap), fruit, water, a beer.', cost: 420, tag: 'Refuel' },
