...
function Block({ b, i, accent }) {
  return (
    ...
    >
      {/* node on the rail */}
      <span
        className="absolute left-[13px] top-[7px] z-10 grid h-6 w-6 -translate-x-1/2 place-items-center rounded-full border-2 bg-ink-950 transition-all duration-500 group-hover:scale-110 sm:left-[21px]"
...
export default function Itinerary() {
  ...
  return (
    <section id="itinerary" className="relative py-24 sm:py-32">
      ...
      {/* ── Day selector ─────────────────────────────────── */}
      <div className="sticky top-[68px] z-30 mb-10 border-y border-white/8 bg-ink-950/85 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          >
            ...
            <div className="relative mb-9 overflow-hidden rounded-2xl border border-white/8">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-9">
                <div className="mb-3 flex flex-wrap items-center gap-3">
                  ...
                  <div>
                    <div className="hanzi text-[12px] tracking-[0.3em] text-white/40">{c.hanzi}</div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
              ...
              <aside className="space-y-5 lg:sticky lg:top-[150px] lg:self-start">
                <div className="rounded-xl border border-gold-400/25 bg-gold-400/[0.07] p-5">
                  <div className="mb-3 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.2em] text-gold-300">
                ...
                <div className="rounded-xl border border-white/8 bg-ink-900 p-5">
                  <div className="mb-3 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.2em] text-vermilion-300">
        ...
        <Reveal>
          <div className="mt-16 rounded-2xl border border-white/8 bg-ink-900/60 p-6 text-center sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[14px] leading-relaxed text-white/45">
              The remaining {inr(100000 - days.reduce((a, x) => a + x.spend, 0))} covers your flights, visa
              and insurance, the eSIM — and leaves genuine buffer. The full arithmetic is below.
            </p>
          </div>
        </Reveal>
      </div>
