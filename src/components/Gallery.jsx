          ...
          >
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 translate-y-1 p-3.5 text-left transition-transform duration-500 group-hover:translate-y-0">
                <div className="font-mono text-[9px] uppercase tracking-[0.2em] text-vermilion-300/90">
                  {g.city}
                </div>
      ...
      <AnimatePresence>
        {open != null && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] flex items-center justify-center bg-ink-950/95 p-4 backdrop-blur-lg sm:p-10"
          ...
          >
            ...
            >
              ...
              <figcaption className="mt-4 flex flex-wrap items-center justify-between gap-3">
                <div>
                  <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-vermilion-300">
                    {gallery[open].city}
                  </div>
