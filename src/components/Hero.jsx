  ...
  return (
    <section ref={ref} id="top" className="relative h-[100svh] min-h-[620px] w-full overflow-hidden">
      <motion.div style={{ y: imgY, scale: imgScale }} className="absolute inset-0">
        <SmartImage
          wiki={meta.heroWiki}
          alt="The Great Wall of China snaking along a forested ridgeline"
          eager
      ...
      >
        <div className="seal hanzi rounded-md border border-vermilion-400/30 bg-vermilion-600/15 px-2.5 py-5 text-sm text-vermilion-200/85 backdrop-blur-sm">
          龙之路 · 七日
        </div>
      </motion.div>
      ...
      >
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/8 px-3.5 py-1.5 font-mono text-[10px] uppercase tracking-[0.26em] text-white/75 backdrop-blur-md">
            <MapPin size={12} className="text-vermilion-400" />
            {meta.tagline}
          </span>
          <span className="inline-flex items-center gap-2 rounded-full border border-jade-400/30 bg-jade-500/12 px-3.5 py-1.5 font-mono text-[10px] uppercase tracking-[0.26em] text-jade-300 backdrop-blur-md">
            Flights included
          </span>
        </motion.div>

        <h1 className="heading text-[clamp(2.8rem,9vw,7.5rem)] tracking-[-0.03em] text-shadow-lg">
          <WordsUp text="Dragon's" delay={0.3} />
          <br className="sm:hidden" />
          <span className="gradient-text">
            <WordsUp text="Trail" delay={0.45} />
          </span>
        </h1>
        ...
        >
          <a
            href="#itinerary"
            className="group relative overflow-hidden rounded-full bg-vermilion-500 px-7 py-3.5 text-sm font-semibold text-white shadow-xl shadow-vermilion-900/50 transition-transform duration-300 hover:scale-[1.04]"
          >
        ...
        >
          ...
          <div className="flex items-baseline gap-2">
            <span className="font-display text-2xl font-bold text-gold-300 sm:text-3xl">₹1,00,000</span>
